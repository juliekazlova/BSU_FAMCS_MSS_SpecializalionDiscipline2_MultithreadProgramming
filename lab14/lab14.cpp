...
int countChar(string::iterator begin, string::iterator end, char a) {
    return count(begin, end, a);
}
...
int main()
{
   ...
   // string s="Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean. A small river named Duden flows by their place and supplies it with the necessary regelialia. It is a paradisematic country, in which roasted parts of sentences fly into your mouth. Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic life One day however a small line of blind text by the name of Lorem Ipsum decided to";
    ...
    time(&start);
     result = countChar(s.begin(), s.end(), a);
     time(&end);
    ...
    string::iterator v0 = s.begin();
    int sz = s.size();
    string::iterator v1 = s.begin();

    time(&start);

    advance(v1, sz / 4);
    auto f0 = async(countChar, v0, v1, a);

    advance(v0, sz / 4); advance(v1, sz / 4);
    auto f1 = async(countChar, v0, v1, a);

    advance(v0, sz / 4); advance(v1, sz / 4);
    auto f2 = async(countChar, v0, v1, a);

    advance(v0, sz / 4); advance(v1, sz / 4);
    auto f3 = async(countChar, v0, v1, a);
